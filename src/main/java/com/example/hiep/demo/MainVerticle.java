...
import com.example.hiep.demo.eventbus.Calculating;
import com.example.hiep.demo.rabbitmq.ClientQueueRequest;
import com.example.hiep.demo.rabbitmq.ClientQueueResponse;
...
public class MainVerticle {
    ...
    public static void main(String[] args) {
        ...
        vertx.deployVerticle(new Calculating());
    }

    public static JWTAuth initJWT(Vertx vertx) {
